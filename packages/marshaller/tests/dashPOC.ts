import { Dashboard } from "../src/index.ts";
    ...
    "datasources": [
        {
            ...
            "fields": [
                { "id": "Airport", "type": "string" },
                { "id": "Airline", "type": "string" }
            ]
        },
        {
            "type": "databomb",
    ...
    "dataviews": [
        {
            ...
            "visualization": {
                    ...
                    "transformations": [
                        {
                            ...
                            "type": "multi",
                            "transformations": [
                                { "fieldID": "Airport", "type": "=", "sourceFieldID": "Airport" },
                                { "fieldID": "Airline", "type": "=", "sourceFieldID": "Airline" }
                            ]
                        }
                    ]
                },
                "properties": {
                    ...
                    "title": "Global Filter",
                    "widget": { "__class": "form_FieldForm", "validate": false, "allowEmptyRequest": true }
                }
            }
        },
        {
            "id": "e_4",
            "datasource": { "id": "airports" },
            "activities": [
                {
                    "type": "filter",
                    "conditions": [{ "viewID": "e_3", "mappings": [{ "remoteFieldID": "Airport", "localFieldID": "code", "condition": "==", "nullable": true }] }]
                },
                {
                    "type": "project",
                    "transformations": [
                        { "fieldID": "Code", "type": "=", "sourceFieldID": "code" },
                        { "fieldID": "Airport", "type": "=", "sourceFieldID": "name" },
                        { "fieldID": "Count", "type": "scale", "sourceFieldID": "count", "factor": 1 }
                    ]
                },
                { "type": "sort", "conditions": [{ "fieldID": "Count", "descending": true }] }
            ],
            "visualization": {
                "id": "cp_4",
                "title": "Airports",
                ...
                "chartType": "Table",
                "__class": "dgrid_Table",
                "mappings": { "type": "mappings", "transformations": [] },
                "properties": {
                    "__class": "marshaller_VizChartPanel",
                    "title": "Airports",
                    "description": "code == ",
        ...
        {
            "id": "e_5",
            "datasource": { "id": "carriers" },
            "activities": [
                {
                    "type": "filter",
                    "conditions": [{ "viewID": "e_3", "mappings": [{ "remoteFieldID": "Airline", "localFieldID": "code", "condition": "==", "nullable": true }] }]
                },
                {
                    "type": "project",
                    "transformations": [
                        { "fieldID": "Code", "type": "=", "sourceFieldID": "code" },
                        { "fieldID": "Airline", "type": "=", "sourceFieldID": "name" },
                        { "fieldID": "Count", "type": "scale", "sourceFieldID": "count", "factor": 1 }
                    ]
                },
                { "type": "sort", "conditions": [{ "fieldID": "Count", "descending": true }] }
    ...
    "properties": {
        ...
        "layout": {
            "main": {
                ...
                "children": [
                    { "type": "tab-area", "widgets": [{ "__id": "cp_4" }], "currentIndex": 0 },
                    { "type": "tab-area", "widgets": [{ "__id": "cp_5" }], "currentIndex": 0 }
                ],
                "sizes": [0.5727843438529976, 0.4272156561470024]
            }
        }
    }
};
...
export function loadDashboard(target: string) {
    return Dashboard.create(target, ddl as any);
}
